...
static constexpr int64_t STALE_CHECK_INTERVAL = 3600 * 24 * 365// CRCRC 10 * 60; // 10 minutes
...
static constexpr int STALE_RELAY_AGE_LIMIT = 3600 * 24 * 365 // CRCRC 30 * 24 * 60 * 60;
