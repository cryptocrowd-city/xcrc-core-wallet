...
BOOST_AUTO_TEST_CASE(descriptor_test)
{
    ...
    Check("pk(LN1aAHwgYpV2sZvmCxJzk5PXA7mnhT3t9P9eT6JPSzVZ2XCkFCwF)", "pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)", SIGNABLE, {{"2103a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bdac"}}, nullopt);
    Check("pkh([deadbeef/1/2'/3/4']LN1aAHwgYpV2sZvmCxJzk5PXA7mnhT3t9P9eT6JPSzVZ2XCkFCwF)", "pkh([deadbeef/1/2'/3/4']03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)", SIGNABLE, {{"76a9149a1c78a507689f6f54b847ad1cef1e614ee23f1e88ac"}}, OutputType::LEGACY, {{1,0x80000002UL,3,0x80000004UL}});
    Check("wpkh(LN1aAHwgYpV2sZvmCxJzk5PXA7mnhT3t9P9eT6JPSzVZ2XCkFCwF)", "wpkh(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)", SIGNABLE, {{"00149a1c78a507689f6f54b847ad1cef1e614ee23f1e"}}, OutputType::BECH32);
    Check("sh(wpkh(LN1aAHwgYpV2sZvmCxJzk5PXA7mnhT3t9P9eT6JPSzVZ2XCkFCwF))", "sh(wpkh(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", SIGNABLE, {{"a91484ab21b1b2fd065d4504ff693d832434b6108d7b87"}}, OutputType::P2SH_SEGWIT);
    ...
    Check("pkh(5PS3yw8rk1LVX32JigGQWF8pcbcXHsJsZFzEvVPX1TAeASgvZPZ)", "pkh(04a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea235)", SIGNABLE, {{"76a914b5bd079c4d57cc7fc28ecf8213a6b791625b818388ac"}}, OutputType::LEGACY);
    ...
    Check("sh(pk(LN1aAHwgYpV2sZvmCxJzk5PXA7mnhT3t9P9eT6JPSzVZ2XCkFCwF))", "sh(pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", SIGNABLE, {{"a9141857af51a5e516552b3086430fd8ce55f7c1a52487"}}, OutputType::LEGACY);
    Check("sh(pkh(LN1aAHwgYpV2sZvmCxJzk5PXA7mnhT3t9P9eT6JPSzVZ2XCkFCwF))", "sh(pkh(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", SIGNABLE, {{"a9141a31ad23bf49c247dd531a623c2ef57da3c400c587"}}, OutputType::LEGACY);
    Check("wsh(pk(LN1aAHwgYpV2sZvmCxJzk5PXA7mnhT3t9P9eT6JPSzVZ2XCkFCwF))", "wsh(pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", SIGNABLE, {{"00202e271faa2325c199d25d22e1ead982e45b64eeb4f31e73dbdf41bd4b5fec23fa"}}, OutputType::BECH32);
    Check("wsh(pkh(LN1aAHwgYpV2sZvmCxJzk5PXA7mnhT3t9P9eT6JPSzVZ2XCkFCwF))", "wsh(pkh(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", SIGNABLE, {{"0020338e023079b91c58571b20e602d7805fb808c22473cbc391a41b1bd3a192e75b"}}, OutputType::BECH32);
    Check("sh(wsh(pk(LN1aAHwgYpV2sZvmCxJzk5PXA7mnhT3t9P9eT6JPSzVZ2XCkFCwF)))", "sh(wsh(pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)))", SIGNABLE, {{"a91472d0c5a3bfad8c3e7bd5303a72b94240e80b6f1787"}}, OutputType::P2SH_SEGWIT);
    Check("sh(wsh(pkh(LN1aAHwgYpV2sZvmCxJzk5PXA7mnhT3t9P9eT6JPSzVZ2XCkFCwF)))", "sh(wsh(pkh(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)))", SIGNABLE, {{"a914b61b92e2ca21bac1e72a3ab859a742982bea960a87"}}, OutputType::P2SH_SEGWIT);
    ...
    /* CRyptoCrowd has larger max script elements than upstream, so the following
    ...
    CheckUnparsable("sh(combo(LN1aAHwgYpV2sZvmCxJzk5PXA7mnhT3t9P9eT6JPSzVZ2XCkFCwF))", "sh(combo(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", "Cannot have combo in non-top level"); // Old must be top level
    ...
    CheckUnparsable("wsh(wpkh(LN1aAHwgYpV2sZvmCxJzk5PXA7mnhT3t9P9eT6JPSzVZ2XCkFCwF))", "wsh(wpkh(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", "Cannot have wpkh within wsh"); // Cannot embed witness inside witness
    CheckUnparsable("wsh(sh(pk(LN1aAHwgYpV2sZvmCxJzk5PXA7mnhT3t9P9eT6JPSzVZ2XCkFCwF)))", "wsh(sh(pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)))", "Cannot have sh in non-top level"); // Cannot embed P2SH inside P2WSH
    CheckUnparsable("sh(sh(pk(LN1aAHwgYpV2sZvmCxJzk5PXA7mnhT3t9P9eT6JPSzVZ2XCkFCwF)))", "sh(sh(pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)))", "Cannot have sh in non-top level"); // Cannot embed P2SH inside P2SH
    CheckUnparsable("wsh(wsh(pk(LN1aAHwgYpV2sZvmCxJzk5PXA7mnhT3t9P9eT6JPSzVZ2XCkFCwF)))", "wsh(wsh(pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)))", "Cannot have wsh within wsh"); // Cannot embed P2WSH inside P2WSH
    ...
    CheckUnparsable("", "raw(U)#00000000", "Invalid characters in payload"); // Invalid chars
}
