...
public:
    CMainParams() {
        ...
        */
        ...
        genesis = CreateGenesisBlock (1588285198, 3854524, 0x1e0ffff0,
                                      pszTimestampMainnet,
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock (1588287358, 225647, 0x1e0ffff0,
                                      pszTimestampTestnet,
                                      uint160S (hexPremineAddressMainnet));
        consensus.hashGenesisBlock = genesis.GetHash();
//                
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock (1588348432, 0, 0x207fffff,
                                      pszTimestampTestnet,
...
//
        assert(consensus.hashGenesisBlock == uint256S("0xc32e9cfd282811e1168d41d5778762810e1adb7c96b48ae6b124ab5e39e27be6"));
