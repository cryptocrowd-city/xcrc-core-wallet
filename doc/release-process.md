...
* Update manpages, see [gen-manpages.sh](https://github.com/cryptocrowd-city/xcrc-core-wallet/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
### Build and sign CRyptoCrowd for Linux, Windows, and macOS:
