...
class DeriveaddressesTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        address = "xcrcrt1qjqmxmkpmxt80xz4y3746zgt0q3u3ferrqen86t"
        ...
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, [1, 2]), ["xcrcrt1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqyem46m", "xcrcrt1qpgptk2gvshyl0s9lqshsmx932l9ccsv2tc9n2l"])
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, 2), [address, "xcrcrt1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqyem46m", "xcrcrt1qpgptk2gvshyl0s9lqshsmx932l9ccsv2tc9n2l"])
